...
# 스레드간 병목현상, 충돌을 방지하고 안전하게 사용할 수 있게
...
# 국가정보 : .split() -> 리스트로 반환해줌
NATION_LS = ('Singapore Germany Israel Norway Italy Canada France Spain Mexico').split()
# 초기 CSV 위치
TARGET_CSV = '/Users/chanjoo/Documents/Python_Advanced/resources/nations.csv'
# 저장 폴더 위치
DEST_DIR = '/Users/chanjoo/Documents/Python_Advanced/csvs'
# CSV 헤더 기초 정보
...
def main(separate_many):
    ...
    start_tm = time.time()
    # 결과 건수
    # ProcessPoolExecutor : GIL 우회, 변경 후 -> os.cpu_count() cpu 사용률 100%
